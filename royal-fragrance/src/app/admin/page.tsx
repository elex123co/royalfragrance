export const metadata = { title: "Admin Dashboard — Royal Fragrance" };
  ...
  return (
    <section className="mx-auto max-w-3xl px-5 py-32 text-center lg:px-8">
      ...
      <p className="mt-4 text-rich/70">
        Central control center — products, orders, vendors, payments, delivery, analytics. Protected route (role: admin).
      </p>
    </section>
  );
}
